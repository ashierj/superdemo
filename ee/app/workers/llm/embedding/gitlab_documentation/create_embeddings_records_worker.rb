...
module Llm
  module Embedding
    module GitlabDocumentation
      class CreateEmbeddingsRecordsWorker
        include ApplicationWorker
        include CronjobQueue # rubocop:disable Scalability/CronWorkerContext -- CreateDbEmbeddingsPerDocFileWorker is queued by this worker, but it requires no context
        include Gitlab::ExclusiveLeaseHelpers
        include EmbeddingsWorkerContext

        idempotent!
        data_consistency :always # rubocop: disable SidekiqLoadBalancing/WorkerDataConsistency -- This worker runs as a cron job
