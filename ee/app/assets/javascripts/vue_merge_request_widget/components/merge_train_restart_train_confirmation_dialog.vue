...
export default {
  ...
  i18n: {
    ...
    cancel: __('Cancel'),
    restartInfo: s__(
      `mrWidget|Merging immediately isn't recommended as it may negatively impact the existing merge train. Read the %{linkStart}documentation%{linkEnd} for more information.`,
    ),
    skipInfo: s__(
