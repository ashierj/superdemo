...
RSpec.describe Gitlab::Analytics::CycleAnalytics, feature_category: :team_planning do
  ...
  describe '.licensed?' do
    where(:model, :enabled_license, :parity_ff_enabled, :outcome) do
      ...
      :public_project_namespace | nil | false | false
      :public_project_namespace | :cycle_analytics_for_groups | false | false
      :public_project_namespace | :cycle_analytics_for_groups | true | false
      :public_project_namespace | :cycle_analytics_for_projects | false | false
      :public_project_namespace | :cycle_analytics_for_projects | true | true
