...
RSpec.describe Ci::Runners::ExportUsageCsvService, feature_category: :fleet_visibility do
  ...
  context 'when current_user is not an admin' do
    ...
    context 'when database is configured', :click_house do
  ...
  context 'when current_user is an admin' do
    ...
    context 'when database is configured', :click_house do
      ...
      context 'when admin mode is enabled', :enable_admin_mode do
        ...
        context 'when runner_performance_insights feature is available', :freeze_time do
          ...
          context 'with builds finished in end of Dec and beginning of Jan' do
