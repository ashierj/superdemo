...
import { resolvers } from 'ee/ci/catalog/graphql/settings';
import getCiCatalogcomponentComponents from 'ee/ci/catalog/graphql/queries/get_ci_catalog_resource_components.query.graphql';
