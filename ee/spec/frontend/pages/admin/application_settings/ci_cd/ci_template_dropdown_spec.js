...
describe('CiTemplateDropdown', () => {
  ...
  describe('renders', () => {
    ...
    it('renders the correct default text', () => {
      expect(findListbox().props('headerText')).toBe(CiTemplateDropdown.i18n.headerText);
      expect(findListbox().props('searchPlaceholder')).toBe(
        CiTemplateDropdown.i18n.searchPlaceholder,
      );
      expect(findListbox().props('resetButtonLabel')).toBe(
        CiTemplateDropdown.i18n.resetButtonLabel,
      );
    });
  });
  ...
  describe('when initial value is not provided', () => {
    ...
    it('renders listbox toggle button with no selected item', () => {
      expect(findListbox().props('toggleText')).toBe(CiTemplateDropdown.i18n.searchPlaceholder);
    });
