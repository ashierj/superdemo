...
RSpec.describe FixBrokenUserAchievements, migration: :gitlab_main, feature_category: :user_profile do
  ...
  describe '#up' do
    describe 'awarded_by_user_id' do
    ...
    describe 'revoked_by_user_id' do
